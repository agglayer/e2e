...
@test "Test triple claim internal calls -> 3 success" {
    ...
    if [[ $? -eq 0 ]]; then
        ...
        log "🌳 First claim proof_local_exit_root: $claim_1_proof_local_exit_root (Expected: $proof_local_exit_root_1)"
        log "🌳 First claim proof_rollup_exit_root: $claim_1_proof_rollup_exit_root (Expected: $proof_rollup_exit_root_1)"
        ...
        log "🌳 Second claim proof_local_exit_root: $claim_2_proof_local_exit_root (Expected: $proof_local_exit_root_2)"
        log "🌳 Second claim proof_rollup_exit_root: $claim_2_proof_rollup_exit_root (Expected: $proof_rollup_exit_root_2)"
        ...
        log "🌳 Third claim proof_local_exit_root: $claim_3_proof_local_exit_root (Expected: $proof_local_exit_root_3)"
        log "🌳 Third claim proof_rollup_exit_root: $claim_3_proof_rollup_exit_root (Expected: $proof_rollup_exit_root_3)"
