...
@test "Test Unset claims Events -> claim in 1 cert, unset claim in 2nd cert and claim unset claim again in same cert" {
  ...
  log "l2_sovereign_admin_private_key: $l2_sovereign_admin_private_key"
  log "L2_RPC_URL: $L2_RPC_URL"
  log "l2_bridge_addr: $l2_bridge_addr"
  log "set_multiple_claims_func_sig: $set_multiple_claims_func_sig"
  log "last_one_global_indexes: ${last_one_global_indexes[0]}"
