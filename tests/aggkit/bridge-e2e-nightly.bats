...
@test "Bridge message A → Bridge asset B → Claim asset A → Claim message B" {
    ...
    run process_bridge_claim "e2e-nightly: $LINENO" "e2e-nightly: $LINENO" "$l1_rpc_network_id" "$bridge_asset_tx_hash" "$l2_rpc_network_id" "$l2_bridge_addr" "$aggkit_bridge_url" "$aggkit_bridge_url" "$L2_RPC_URL" "$sender_addr"
    assert_success
    ...
    run process_bridge_claim "e2e-nightly: $LINENO" "e2e-nightly: $LINENO" "$l1_rpc_network_id" "$bridge_message_tx_hash" "$l2_rpc_network_id" "$l2_bridge_addr" "$aggkit_bridge_url" "$aggkit_bridge_url" "$L2_RPC_URL" "$sender_addr"
    assert_success
}
...
@test "Bridge message A → Bridge asset B → Claim message A → Claim asset B" {
    ...
    echo "====== claimMessage (L2)" >&3
    run process_bridge_claim "e2e-nightly: $LINENO" "$l1_rpc_network_id" "$bridge_message_tx_hash" "$l2_rpc_network_id" "$l2_bridge_addr" "$aggkit_bridge_url" "$aggkit_bridge_url" "$L2_RPC_URL" "$sender_addr"
    assert_success

    # Step 4: Claim the bridged asset on L2
    echo "==== 🔐 Claiming asset deposit on L2 ($L2_RPC_URL)" >&3
    run process_bridge_claim "e2e-nightly: $LINENO" "$l1_rpc_network_id" "$bridge_asset_tx_hash" "$l2_rpc_network_id" "$l2_bridge_addr" "$aggkit_bridge_url" "$aggkit_bridge_url" "$L2_RPC_URL" "$sender_addr"
    assert_success
...
@test "Bridge asset A -> Claim asset A -> Bridge asset B -> Claim asset B" {
    ...
    run process_bridge_claim "e2e-nightly: $LINENO" "$l1_rpc_network_id" "$bridge_tx_hash_a" "$l2_rpc_network_id" "$l2_bridge_addr" "$aggkit_bridge_url" "$aggkit_bridge_url" "$L2_RPC_URL" "$sender_addr"
    assert_success
    ...
    run process_bridge_claim "e2e-nightly: $LINENO" "$l1_rpc_network_id" "$bridge_tx_hash_b" "$l2_rpc_network_id" "$l2_bridge_addr" "$aggkit_bridge_url" "$aggkit_bridge_url" "$L2_RPC_URL" "$sender_addr"
    assert_success
