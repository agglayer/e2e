...
@test "ERC20 token deposit L2 -> L1" {
    ...
    echo "=== 🪤 Running L1 bridge to update l1infotree" >&3
    ...
    bridge_tx_hash=$output
     ...
     echo "=== 🪤 2nd: Running L1 bridge to update l1infotree" >&3
    run update_l1_info_tree 1 "2nd bridge/1: "
    run update_l1_info_tree 30 "2nd bridge/2: "
    run update_l1_info_tree 30 "2nd bridge/3: "
    assert_success
