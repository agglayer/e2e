...
{
    echo "container: $(IFS=,; echo "${CONTAINERS[*]}")"
...
pict "$PICT_MODEL" /r /o:2 | awk 'BEGIN {FS="\t"; print "["} NR>1 {if (NR>2) print ","; print "  {"; print "    \"container\": \"" $1 "\","; print "    \"percent\": " $2 ","; print "    \"probability\": " $3 ","; print "    \"rate\": \"" $4 "\","; print "    \"jitter\": " $5; print "  }"} END {print "]"}' > test_matrix.json
