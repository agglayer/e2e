...
@test "transactions consuming significant gas do not halt chain" {
    ...
    local burn_bytecode=""
    ...
    contract_addr=$(cast send --rpc-url "$L2_RPC_URL" --private-key "$PRIVATE_KEY" \
        --gas-price "$comp_gas_price" --legacy --create "$burn_bytecode" --json 2>&1 \
