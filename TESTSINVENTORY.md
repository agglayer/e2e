...
| send 1 tx per block until a new certificate settles | [Link](./tests/agglayer/nonce-tests.bats#L169) | |
...
| send txs from nonce+1 to nonce+10 using aggregator private key | [Link](./tests/agglayer/nonce-tests.bats#L157) | |
