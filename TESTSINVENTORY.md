...
| ERC20 token deposit L1 -> L2 | [Link](./tests/aggkit/bridge-e2e.bats#L35) | |
| ERC20 token deposit L2 -> L1 | [Link](./tests/aggkit/bridge-e2e.bats#L117) | |
...
| Native token transfer L1 -> L2 - manipulated global index | [Link](./tests/aggkit/bridge-e2e.bats#L298) | |
| Native token transfer L1 -> L2 | [Link](./tests/aggkit/bridge-e2e.bats#L246) | |
...
| Transfer message | [Link](./tests/aggkit/bridge-e2e.bats#L13) | |
