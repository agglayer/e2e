...
| send 1 tx per block for N blocks | [Link](./tests/agglayer/nonce-tests.bats#L164) | |
| send a tx using aggregator private key | [Link](./tests/agglayer/nonce-tests.bats#L119) | |
| send many async txs using aggregator private key | [Link](./tests/agglayer/nonce-tests.bats#L133) | |
| send many txs using aggregator private key | [Link](./tests/agglayer/nonce-tests.bats#L126) | |
| send tx with nonce+1 using aggregator private key | [Link](./tests/agglayer/nonce-tests.bats#L140) | |
| send txs from nonce+1 to nonce+10 using aggregator private key | [Link](./tests/agglayer/nonce-tests.bats#L152) | |
| wait for a new certificate to be settled | [Link](./tests/agglayer/nonce-tests.bats#L112) | |
