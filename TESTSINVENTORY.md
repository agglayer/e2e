...
|-----------|-----------|-------|
| Initial setup | [Link](./tests/lxly/bridge-tests-suite.bats#L90) | |
| Process bridge scenarios with dynamic network routing and claim deposits in parallel | [Link](./tests/lxly/bridge-tests-suite.bats#L133) | |
| Reclaim test funds | [Link](./tests/lxly/bridge-tests-suite.bats#L363) | |
