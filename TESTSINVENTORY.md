...
|-----------|-----------|-------|
| Initial setup | [Link](./tests/lxly/bridge-tests-suite.bats#L81) | |
| Process L1 to L2 bridge scenarios and claim deposits in parallel | [Link](./tests/lxly/bridge-tests-suite.bats#L103) | |
| Process L2 to L1 bridge scenarios and claim deposits in parallel | [Link](./tests/lxly/bridge-tests-suite.bats#L305) | |
| Reclaim test funds | [Link](./tests/lxly/bridge-tests-suite.bats#L536) | |
| Run address tester actions | [Link](./tests/lxly/bridge-tests-suite.bats#L505) | |
...
| L1 → Rollup 1 (native) → Rollup 3 | [Link](./tests/aggkit/bridge-e2e-3-chains.bats#L143) | |
| L1 → Rollup 3 (native/WETH) → Rollup 1 | [Link](./tests/aggkit/bridge-e2e-3-chains.bats#L16) | |
| Native token transfer L1 -> L2 - manipulated global index | [Link](./tests/aggkit/bridge-e2e.bats#L274) | |
| Native token transfer L1 -> L2 | [Link](./tests/aggkit/bridge-e2e.bats#L224) | |
