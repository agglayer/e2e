...
_common_multi_setup() {
    ...
    readonly aggkit_pp1_rest_url=$(kurtosis port print $ENCLAVE cdk-node-001 rest)
    readonly aggkit_pp2_rest_url=$(kurtosis port print $ENCLAVE cdk-node-002 rest)
    ...
    echo "=== Aggkit PP1 REST URL=$aggkit_pp1_rest_url ===" >&3
    echo "=== Aggkit PP2 REST URL=$aggkit_pp2_rest_url ===" >&3
