...
kurtosis run \
         --enclave "$kurtosis_enclave_name" \
         --args-file ./op-geth-pp-single-network.yml \
         "github.com/0xPolygon/kurtosis-cdk@$kurtosis_hash"                                                                           
...
run_agglayer_bridging "CDK-OPGeth-PP Bridging" "op-el-1-op-geth-op-node-001" "sovereign-bridge-service-001" "0x99e73731E5f6A6bB29AFD5e38D047Ce9Cc10C684" "0x21200F7501bEe9a06628d27c5e59b0F34E54487e" "0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80" "0xD71f8F956AD979Cc2988381B8A743a2fE280537D" > ./scenarios/upgrade-agglayer/op-geth-pp-bridging.log 2>&1 & pids+=($!)
