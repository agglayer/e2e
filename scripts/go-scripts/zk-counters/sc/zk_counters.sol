...
contract ZkCounters {
    ...
    function outOfCountersSteps() public {
        ...
        revert("failed to execute the unsigned transaction: main execution exceeded the maximum number of steps");
